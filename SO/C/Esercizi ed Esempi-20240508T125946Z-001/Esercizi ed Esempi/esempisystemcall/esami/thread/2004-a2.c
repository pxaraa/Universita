/**
	...
	Realizzare un programma in C che svolga  quanto segue: il tread main iniziale
   crei due thread di nome Th1 e Th2. I due thread condividono la variabile intera A alla quale 
   inizialmente � assegnato il valore 10. Il thread Th1 incrementa di 1 il valore di A e attende 1 secondo,
    mentre Th2 decrementa di 1 il valore di A e attende 1 secondo. Entrambi i thread eseguono le operazioni suddette 
    per 10 volte, quindi terminano. 
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
